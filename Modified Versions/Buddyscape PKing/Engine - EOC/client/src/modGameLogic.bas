...
PageOn = Conv(ConvIndex).Chat(PageOn).ReplyConvTo(Choice)
    ...
    With frmMain
        ...
        For i = 1 To 4
            ...
            If Conv(ConvIndex).Chat(1).QuestRequirement(i).Index > 0 Then
                Select Case Conv(ConvIndex).Chat(1).QuestRequirement(i).Condition
                    Case 1 'is equal to
                        If Player(MyIndex).PlayerQuest(Conv(ConvIndex).Chat(1).QuestRequirement(i).Index).TaskOn <> Conv(ConvIndex).Chat(1).QuestRequirement(i).Task Then
