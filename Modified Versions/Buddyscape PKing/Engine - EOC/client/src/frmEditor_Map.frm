   ...
   Begin VB.PictureBox picAttributes 
      ...
      Begin VB.Frame fraRec 
         ...
         Begin VB.Label lblCondi 
            ...
            Width           =   2295
         End
         Begin VB.Label lblAdi 
            Caption         =   "Task Required: 0"
            Height          =   255
            Left            =   240
            TabIndex        =   107
            Top             =   1560
...
Private Sub scrlAdi_Change()

lblAdi.Caption = "Task Required: " & scrlAdi.Value
RecAditional = scrlAdi.Value

End Sub

Private Sub scrlCondi_Change()

Select Case scrlCondi.Value
    Case 1
        lblCondi.Caption = "Is equal to"
    Case 2
        lblCondi.Caption = "Is smaller than"
    Case 3
        lblCondi.Caption = "Is bigger than"
End Select

RecCondi = scrlCondi.Value
...
Select Case scrlType.Value
    'quests
    Case 0
        lblType.Caption = "Quest: " & scrlIndex.Value
        If scrlIndex.Value > 0 Then
            lblType.Caption = lblType.Caption & " " & Trim$(Quest(scrlIndex.Value).Name)
        Else
            lblType.Caption = lblType.Caption & " None"
        End If
    'level
    Case 1
        lblIndex.Caption = "Level: " & scrlIndex.Value
    'WCXP
    Case 2
        lblIndex.Caption = "WoodcuttingXP: " & scrlIndex.Value
    'Miningxp
    Case 3
        lblIndex.Caption = "MiningXP: " & scrlIndex.Value
    'fishingxp
    Case 4
        lblIndex.Caption = "FishingXP: " & scrlIndex.Value
    'smithingxp
    Case 5
        lblIndex.Caption = "SmithingXP: " & scrlIndex.Value
    'cookingxp
    Case 6
        lblIndex.Caption = "CookingXP: " & scrlIndex.Value
    'fletchingxp
    Case 7
        lblIndex.Caption = "FletchingXP: " & scrlIndex.Value
    'craftingxp
    Case 8
        lblIndex.Caption = "CraftingXP: " & scrlIndex.Value
    'potionbrewingxp
    Case 9
        lblIndex.Caption = "PotionBrewingXP: " & scrlIndex.Value
End Select

RecIndex = scrlIndex.Value
...
Private Sub scrlType_Change()

If scrlType.Value > 0 Then
        scrlAdi.Value = 1
        lblAdi.Caption = "Task Required: 0"
        scrlAdi.Visible = False
        lblAdi.Visible = False
        scrlCondi.Visible = False
        lblCondi.Visible = False
End If
...
Select Case scrlType.Value
    ...
    Case 0
        ...
        scrlAdi.Visible = True
        lblAdi.Visible = True
        scrlCondi.Visible = True
        lblCondi.Visible = True
    'level
    Case 1
        scrlIndex.Max = MAX_LEVELS
        lblType.Caption = "Level: "
    'WCXP
    Case 2
        lblType.Caption = "WoodcuttingXP: "
    'Miningxp
    Case 3
        lblType.Caption = "MiningXP: "
    'fishingxp
    Case 4
        lblType.Caption = "FishingXP: "
    'smithingxp
    Case 5
        lblType.Caption = "SmithingXP: "
    'cookingxp
    Case 6
        lblType.Caption = "CookingXP: "
    'fletchingxp
    Case 7
        lblType.Caption = "FletchingXP: "
    'craftingxp
    Case 8
        lblType.Caption = "CraftingXP: "
    'potionbrewingxp
    Case 9
        lblType.Caption = "PotionBrewingXP: "
End Select

RecType = scrlType.Value
