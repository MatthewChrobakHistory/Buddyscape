...
' Anti-spam food eating
Public CanConsume(1 To MAX_PLAYERS) As Boolean

Public XPRate As Double
Public DecreaseRate As Double
Public StopAt As Double
Public GoUp As Boolean
Public DInterval As Long
