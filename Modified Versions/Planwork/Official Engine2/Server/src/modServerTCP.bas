...
Function IsPlaying(ByVal index As Long) As Boolean
    ...
    If IsConnected(index) = True Then
...
Public Sub MapCache_Create(ByVal mapnum As Long)
    ...
    Buffer.WriteByte Map(mapnum).InstanceHost
    Buffer.WriteByte Map(mapnum).IsInstanced
    Buffer.WriteByte Map(mapnum).MinLevel
...
Function PlayerData(ByVal index As Long) As Byte()
    ...
    Buffer.WriteLong GetPlayerLNIM(index)
...
Public Sub SendStartConversation(ByVal index As Long, ByVal ConvIndex As Long, ByVal NPCIndex As Long)
    Dim Buffer As clsBuffer
