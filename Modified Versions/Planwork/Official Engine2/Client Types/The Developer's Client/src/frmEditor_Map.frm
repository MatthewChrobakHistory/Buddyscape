...
Select Case scrlType.Value
    'quests
    Case 0
        If scrlIndex.Value > 0 And scrlIndex.Value < MAX_QUESTS Then
            lblIndex.Caption = "Quest " & scrlIndex.Value & ": " & Trim$(Quest(scrlIndex.Value).Name)
        End If
    'level
    Case 1
...
Private Sub scrlMapWarp_Change()
    ...
    If scrlMapWarp.Value = 0 Then
        lblMapWarp.Caption = "Map: Random Dungeon"
    Else
