...
Begin VB.Form frmEditor_NPC 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame Frame4 
         ...
         Top             =   6120
         Width           =   2295
         Begin VB.HScrollBar scrlOnDeath 
            Height          =   255
            Left            =   120
            TabIndex        =   96
            Top             =   1080
            Width           =   2055
         End
         Begin VB.HScrollBar scrlOnAttack 
            Height          =   255
            Left            =   120
            TabIndex        =   95
            Top             =   480
      ...
      Begin VB.ComboBox cmbBehaviour 
         Height          =   300
         ItemData        =   "frmEditor_NPC.frx":3359
         Left            =   960
         List            =   "frmEditor_NPC.frx":336C
         Style           =   2  'Dropdown List
         TabIndex        =   17
         Top             =   1680
         Width           =   1575
...
Npc(EditorIndex).AttackType = cmbStyle.ListIndex
...
Npc(EditorIndex).MagicDefense = scrlMagicDefense.Value
...
Npc(EditorIndex).MagicOffense = scrlMagicOffense.Value
...
Npc(EditorIndex).MeleeDefense = scrlMeleeDefense.Value
...
Npc(EditorIndex).MeleeOffense = scrlMeleeOffense.Value

End Sub

Private Sub scrlOnAttack_Change()

lblOnAttack.Caption = "On Attack: " & scrlOnAttack.Value
Npc(EditorIndex).AliveCustomScript = scrlOnAttack.Value

End Sub

Private Sub scrlOnDeath_Change()

lblOnDeath.Caption = "On Death: " & scrlOnDeath.Value
Npc(EditorIndex).DeadCustomScript = scrlOnDeath.Value
...
Npc(EditorIndex).RangedDefense = scrlRangedDefense.Value
...
Npc(EditorIndex).RangedOffense = scrlRangedOffense.Value
...
If IsNumeric(txtSpeed.Text) = False Then txtSpeed.Text = 4
If txtSpeed.Text > 8 Then txtSpeed.Text = 8
If txtSpeed.Text < 2 Then txtSpeed.Text = 2

Npc(EditorIndex).Speed = txtSpeed.Text
