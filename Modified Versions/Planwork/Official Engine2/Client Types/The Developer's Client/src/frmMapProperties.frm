...
Begin VB.Form frmEditor_MapProperties 
   ...
   Begin VB.Frame fraMapSettings 
      ...
      Begin VB.TextBox txtMinLevel 
         ...
         Width           =   735
      End
      Begin VB.CheckBox chkIsInstanced 
         Caption         =   "Is Instanced?"
         Height          =   255
         Left            =   1920
         TabIndex        =   34
         Top             =   600
         Width           =   2175
      End
      Begin VB.CheckBox chkInstanceHost 
         Caption         =   "Instance Host?"
         Height          =   255
         Left            =   1920
         TabIndex        =   33
         Top             =   360
...
Private Sub chkInstanceHost_Click()

If Me.chkIsInstanced.Value = 1 Then
    Me.chkIsInstanced.Value = 0
End If

End Sub

Private Sub chkIsInstanced_Click()

If Me.chkInstanceHost.Value = 1 Then
    Me.chkInstanceHost.Value = 0
End If
...
Private Sub cmdOk_Click()
    ...
    With Map
        ...
        If chkDIOD.Value = 1 Then
            .DropItemsOnDeath = True
        Else
            .DropItemsOnDeath = False
        End If
        
        If chkInstanceHost.Value = 1 Then
            .InstanceHost = True
        Else
            .InstanceHost = False
        End If
        
        If chkIsInstanced.Value = 1 Then
            .IsInstanced = True
        Else
            .IsInstanced = False
        End If
...
If IsNumeric(txtMinLevel.Text) = False Then
    txtMinLevel.Text = "0"
Else
    If txtMinLevel.Text > MAX_LEVELS Then
        txtMinLevel.Text = MAX_LEVELS
    ElseIf txtMinLevel.Text < 0 Then
        txtMinLevel.Text = 0
    End If
End If

Map.MinLevel = txtMinLevel.Text
