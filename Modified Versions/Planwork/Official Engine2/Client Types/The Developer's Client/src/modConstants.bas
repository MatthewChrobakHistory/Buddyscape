...
Public Const MAX_QUEST_TASKS As Long = 50
...
'MATT TILE
Public Const TILE_TYPE_REC As Byte = 17
...
Public Const EDITOR_CONV As Byte = 8
...
' char stats
Public Const CHAR_STATE_RAW As Byte = 0
Public Const CHAR_STATE_EQUIP As Byte = 1
