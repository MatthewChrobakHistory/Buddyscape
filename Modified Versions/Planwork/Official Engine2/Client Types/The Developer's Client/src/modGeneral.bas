...
Dim i As Long
    ...
    frmMain.picQuest.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\buttons\quests.jpg")
    frmMain.picBook.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\book.jpg")
    frmMain.imgClose.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\bookExit.jpg")
...
XStat = GetPlayerStat(Index, Stat)

For i = 1 To Equipment.Equipment_Count - 1
    If GetPlayerEquipment(Index, i) > 0 Then
        XStat = XStat - Item(GetPlayerEquipment(Index, i)).Add_Stat(Stat)
    End If
Next

GetPlayerRawStat = XStat
