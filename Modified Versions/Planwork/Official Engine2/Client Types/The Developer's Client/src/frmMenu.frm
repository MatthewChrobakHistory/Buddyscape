...
Call MsgBox("Login failed. The server may be online, but under maintanence. Please try again. If this problem continues, wait a little while before re-logging. Thank you for your understanding.", vbCritical)
